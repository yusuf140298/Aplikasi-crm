<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Product Sablon</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=site_url('Product')?>">Product</a></li>
              <li class="breadcrumb-item active">Update Product Sablon</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-10">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <?=form_open_multipart('Product/update_sablon')?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="items">Nama Ukuran</label>
                                    <input type="hidden" name="id_sablon" value="<?=$row->id_sablon?>">
                                    <input type="text" class="form-control <?=form_error('ukuran')== !null ? "is-invalid": null?>" id="ukuran" name="ukuran" placeholder="Masukan Nama ukuran" value="<?=$this->input->post('ukuran') ?? $row->ukuran_sablon?>"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?=form_error('spesifikasi')== !null ? "is-invalid": null?>" id="spesifikasi" name="spesifikasi" placeholder="Masukan spesifikasi" value="<?=$this->input->post('spesifikasi') ?? $row->spesification?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    if($row->image != null){?>
                                     <div class="mb-3 bg-indigo p-3 text-center">
                                        <img src="<?=base_url()?>uploads/img_sablon/<?=$row->image?>" style="width:20%">
                                     </div>   
                                    <?php
                                    }
                                    ?>
